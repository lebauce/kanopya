use utf8;
package AdministratorDB::Schema::Result::ScalabilityPolicy;
...
=head1 TABLE: C<scalability_policy>

=cut

__PACKAGE__->table("scalability_policy");
...
=item * L</scalability_policy_id>

=back

=cut

__PACKAGE__->set_primary_key("scalability_policy_id");
...
__PACKAGE__->has_many(
  ...
  { "foreign.scalability_policy_id" => "self.scalability_policy_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07024 @ 2012-12-06 10:18:24
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0GvUcjXKQEaQo4EPyJYT2Q
