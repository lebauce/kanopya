...
use constant POLICY_ATTR_DEF => {
    cluster_domainname => {
        ...
        is_mandatory => 1,
        order        => 1,
	description  => 'The domain name for the service or instance',
    },
    cluster_nameserver1 => {
        label        => 'Name server 1',
        type         => 'string',
        ...
        is_mandatory => 2,
        order        => 2,
	description  => 'The primary domain name server (DNS)',
    },
    cluster_nameserver2 => {
        label        => 'Name server 2',
        type         => 'string',
        ...
        is_mandatory => 1,
        order        => 3,
	description  => 'The secondary domain name server (DNS)',
    },
    default_gateway_id => {
        ...
        is_mandatory => 1,
        order        => 4,
	description  => 'The network hosting the default gateway',
    },
    network_manager_id => {
        ...
        is_mandatory => 1,
        order        => 5,
	description  => 'The Network manager for the network of this infrastructure',
    },
};
