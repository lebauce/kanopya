use utf8;
package Kanopya::Schema::Result::LocalContainerAccess;
...
=head1 TABLE: C<local_container_access>
...
=item * L</local_container_access_id>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zzR365cAQ94Uq1quoPBLmA
