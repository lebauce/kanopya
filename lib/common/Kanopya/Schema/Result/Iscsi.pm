use utf8;
package Kanopya::Schema::Result::Iscsi;
...
Related object: L<Kanopya::Schema::Result::IscsiPortal>
...
Related object: L<Kanopya::Schema::Result::Iscsitarget1>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dlgXQxxM39GFdyW3g9z6Kw
