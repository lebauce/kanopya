use utf8;
package Kanopya::Schema::Result::FileContainerAccess;
...
=head1 TABLE: C<file_container_access>
...
=item * L</file_container_access_id>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:76lSFoG/H1miNNtbzaZSQg
