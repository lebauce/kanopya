...
Log::Log4perl->easy_init({level=>'DEBUG', file=>'/tmp/node_disabling.log', layout=>'%F %L %p %m%n'});
...
eval{
    ...
    @indicators = ScomIndicator->search (hash => {service_provider_id => $service_provider->id});
