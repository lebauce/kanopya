...
use constant SERVICE_NAME => 'kanopya-aggregator';
use constant SERVICE_DESC => 'Aggregator service for Kanopya';
    ...
    if(SERVICE_RUNNING == Win32::Daemon::State()) {
        ...
        if ($context->{pid} == 0) { # Child
            while (1 == 1) {
                ...
                my $cmd = "perl \"$context->{dir}\\kanopya\\sbin\\kanopya-aggregator\"";
                print $cmd."\n";
                system($cmd);
            }
        }
            ...
            #TODO kill the process with PID - DO NOT USE FORK ON WINDOWS
            print "SERVICE STOP PENDING IS RECEIVED\n";
            Win32::Daemon::State(SERVICE_STOPPED);
            Win32::Daemon::StopService();
            my $tokill = 'aggregator';
