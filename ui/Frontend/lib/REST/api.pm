...
our %resources = (
    ...
    "aggregatecombination"     => "Entity::Metric::Combination::AggregateCombination",
    ...
    "anomaly"                  => "Entity::Metric::Anomaly",
    "aws"                      => "Entity::Component::Virtualization::AwsAccount",
    "billinglimit"             => "Entity::Billinglimit",
    "billingpolicy"            => "Entity::Policy::BillingPolicy",
    "cinder"                   => "Entity::Component::Cinder",
    "classtype"                => "ClassType",
    "cluster"                  => "Entity::ServiceProvider::Cluster",
    "clustermetric"            => "Entity::Metric::Clustermetric",
    "collectorindicator"       => "Entity::CollectorIndicator",
    "combination"              => "Entity::Metric::Combination",
    ...
    "glance"                   => "Entity::Component::Glance",
    "gp"                       => "Entity::Gp",
    ...
    "nodemetriccombination"    => "Entity::Metric::Combination::NodemetricCombination",
    ...
    "openstack"                => "Entity::Component::Virtualization::OpenStack",
    ...
    "neutron"                  => "Entity::Component::Neutron",
    "quota"                    => "Quota",
